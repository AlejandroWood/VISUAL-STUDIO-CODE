...
public class EjemploOperadoresComparacion {
    ...
    public static void main(String[] args) {
        ...
        // Con esta istruccion leemos un valor entero
        ...
        // La estructura if valora si es cierta o falsa la condicion, en caso de ser cierta
        ...
        //Pesar menos de 80.5 kg y cumplir con una de las siguientes dos condiciones
        //Hacer caso a su padre(boolean) o tener mas de rango 5 en google fit(int)
        float peso = 87;
        int googleFitLvl = 5;
        boolean haceCasoFather = true;
        ...
        if ((haceCasoFather==true && peso!=90) || googleFitLvl>10) {
            System.out.println("Estas alelao pero pudiste volver a por las llaves\n P.d.Que sepas que las alas ya se han fundido y estas atrapado de nuevo");
        }
